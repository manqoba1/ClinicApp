...
public class SharedUtil {
    ...
    public static PatientDTO getPatient(Context ctx) {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(ctx);
        String st = sp.getString(PATIENT_JSON, null);
        PatientDTO tm = null;
        if (st != null) {
            tm = gson.fromJson(st, PatientDTO.class);
        }
        return tm;
    }

    public static void savePatientr(Context ctx, PatientDTO evi) {

        SharedPreferences sp = PreferenceManager
                .getDefaultSharedPreferences(ctx);
        SharedPreferences.Editor ed = sp.edit();

        ed.putString(PATIENT_JSON, gson.toJson(evi));
        ed.commit();
